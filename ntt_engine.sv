module ntt_engine (
  ...
  //==========================================================================
  // Butterfly Datapath -- Stage 3 (combinational in ST_NORM, only entered
  // on the final INTT stage): N^-1 normalization, its own multiply+reduce
  // chain, now on a separate clock edge from the butterfly's own multiply.
  //==========================================================================
